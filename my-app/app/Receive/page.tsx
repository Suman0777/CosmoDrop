        ...
        >
          ...
          <div className="flex flex-col gap-2.5">
            {steps.map(({ n, text }, i) => (
              ...
              >
                <span className="shrink-0 w-5 h-5 sm:w-6 sm:h-6 rounded-full border border-cyan-400/30 bg-cyan-500/10 flex items-center justify-center text-[9px] sm:text-[10px] font-bold text-cyan-300">
                  {n}
                </span>
